...
<!-- BEGIN PAGE LEVEL JS -->
<script src="http://localhost/myapp2/assets/javascript/pages/dashboard-demo.js"></script> <!-- END PAGE LEVEL JS -->
...
<script>
    $(document).ready(function() {
        ...
        $("#fr").on("click", ".confirm-delete", function() {
        ...
        ///Modal edit button
        $("#fr").on("click", ".edit-modal", function(event) {
