...
*/
$route['default_controller'] = 'Frontend/EmployeeController';
// $route['test'] = 'test/hello';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['test1/(:any)'] = 'custom/para/$1';
//---------------------------------
//
$route['employee']='Frontend/EmployeeController/index';
$route['employee/dataTable']='Frontend/EmployeeController/showDatatable';
$route['employee/add']='Frontend/EmployeeController/create';
$route['employee/store']='Frontend/EmployeeController/store';
$route['employee/get']='Frontend/EmployeeController/getTest';
$route['employee/edit/(:any)']='Frontend/EmployeeController/edit/$1';
$route['employee/edit_modal/(:any)']='Frontend/EmployeeController/edit_modal/$1';
